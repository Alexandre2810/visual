...
const contain_canva3 = document.querySelector('.contain-canvasVisu');
...
function removePart() {
    ...
    contain_canva3.classList.add('hide_contain-canvas2');
}
...
function affPart0 () {
    ...
    contain_canva.classList.remove('show_contain-canvas');
    contain_canva2.classList.remove('show_contain-canvas2');
    contain_canva3.classList.remove('hide_contain-canvas2');
}
